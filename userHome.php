                                    ...
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                           ...
                                           <img src="product/<?php echo $row['images']; ?>" width="200" height="150"><br>
											...
											<p style="color:forestgreen" align="center"><b> ₹<?php echo $row['sell']; ?>/Kg</b></p>
											<div align="center"><a href="addCart.php?cId=<?php echo $row['productId'];?>"><button class="btn btn-sm btn-warning">BUY NOW</button></a></div>
										</diV>
                                    </div>
                                </div>
                            </div>
